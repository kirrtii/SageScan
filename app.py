...
def xray_upload():
    global uploaded_image, predicted_class_label  # Declare global variables
    ...
    if uploaded_file is not None:
        ...
        # Make a prediction
        predictions = loaded_model.predict(preprocess_image(img))[0]  # Get the prediction for the uploaded image
